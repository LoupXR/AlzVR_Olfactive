...
namespace Unity.VRTemplate {
    ...
    public class SmartFollowQuaternionTweenableVariable : QuaternionTweenableVariable {
        ...
        /// <param name="maxAngleAllowed">
        ///     Maximum angle offset (in degrees) from target before tween targets, when time threshold
        ///     is reached.
        /// </param>
        /// <param name="minToMaxDelaySeconds">
        ///     Time required to elapse (in seconds) before the max angle offset allowed goes from
        ///     the min angle offset to the max.
        /// </param>
        ...
        /// <summary>
        ///     Checks if the angle difference between the current target rotation and a new target rotation is within a
        ...
        /// <returns>
        ///     Returns true if the angle difference between the current and new targets is within the allowed threshold,
        ///     false otherwise.
        /// </returns>
        public bool IsNewTargetWithinThreshold(Quaternion newTarget) {
            ...
            float allowedTargetAngleOffset = Mathf.Lerp(minAngleAllowed, maxAngleAllowed,
                Mathf.Clamp01(timeSinceLastUpdate / minToMaxDelaySeconds));
        ...
        public void HandleSmartTween(float deltaTime, float lowerSpeed, float upperSpeed) {
            ...
            ComputeNewTweenTarget(deltaTime, angleOffsetDeg, maxAngleAllowed, lowerSpeed, upperSpeed,
        ...
        [BurstCompile]
#endif
        private static void ComputeNewTweenTarget(in float deltaTime, in float angleOffsetDeg, in float maxAngleAllowed,
            in float lowerSpeed, in float upperSpeed, out float newTweenTarget) {
