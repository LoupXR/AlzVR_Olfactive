...
namespace Unity.VRTemplate {
    ...
    public class XRKnob : XRBaseInteractable {
        ...
        private void OnDrawGizmosSelected() {
            ...
            Vector3 circleX = transform.right;
            Vector3 circleY = transform.forward;
        ...
        private void EndGrab(SelectExitEventArgs args) { m_Interactor = null; }
        ...
        private void UpdateRotation(bool freshCheck = false) {
            ...
            float knobRotation = m_BaseKnobRotation -
        ...
        private void SetValue(float value) {
            ...
            if (m_AngleIncrement > 0) {
                ...
                float angle = Mathf.Lerp(0.0f, angleRange, value);
